/**************************************************************
*   Distributed Proxy Test -- Server-delegation Process       *
*   by Daniel Wang                                            *
***************************************************************/
...
int outproxy_ep, inproxy_ep, client_ep;
...
void initialize(){
    ...
    printf("[SERVER-PROXY]: client_ep=%d, outproxy_ep=%d, inproxy_ep=%d\n", client_ep, outproxy_ep, inproxy_ep);
}
...
void main(int argc, char ** argv){
    ...
    while(1){
        ...
        if(who_e == client_ep)
            ...
            printf("[SERVER-PROXY]: warning, got illegal request from %d\n", m.m_source);
    }
    exit(0);
}